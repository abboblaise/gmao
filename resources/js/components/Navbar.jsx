...
const Navbar = () => {
    const {activeMenu, setactiveMenu, screenSize, setScreenSize, handleClick, isClicked, currentColor} = useStateContext()
    ...
    return (
        <div className='flex justify-between p-2 md:mx-6 relative rounded-2xl' style={{ background: currentColor }}>
            <NavButton title="Menu" customFunc={() => setactiveMenu(!activeMenu)} color={'white'} icon={<AiOutlineMenu />} />
                ...
                <TooltipComponent content="Profile" position='BottomCenter'>
                    ...
                    hover:bg-light-gray rounded-lg' onClick={()=>handleClick('userProfile')}>
                        ...
                        <p>
                            ...
                            <span className='text-gray-500 font-bold ml-1 text-14'>Admin</span>
                        </p>
