...
Route::get('/color-mapping', [\App\Http\Controllers\HomeController::class,"colorMapping"])->name("dummy.color-mapping");
...
Route::post('/set-dash', [\App\Http\Controllers\HomeController::class,"setDashParam"])->name("dummy.set-dash");
