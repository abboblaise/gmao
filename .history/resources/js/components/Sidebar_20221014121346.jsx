...
const Sidebar = () => {
    ...
    const activeLink ='flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white text-md m-2 bg-gray-300'
        ...
        <div className="ml-3 h-screen md:overflow-hidden overflow-auto md:hover:overflow:auto pb-10">
            {activeMenu && (<>
                <div className="flex justify-between items-center">
                    <Link href={"/"} onClick={() => setDashState({...dashState, activeMenu:false})}
