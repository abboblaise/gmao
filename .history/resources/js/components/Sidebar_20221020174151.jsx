...
const Sidebar = ({ dashState, setDashState,  }) => {
    ...
    return (
        <div className="relative ml-3 h-screen  overflow-auto md:hover:overflow:auto pb-10">
            {activeMenu && (<>
                <div className="flex justify-between items-center">
                    <Link href={"/"} onClick={handleCloseSidebar}
                    className="items-center sticky gap-3 ml-3 mt-4 flex text-xl font-extrabold tracking-tight dark:text-white text-slate-900">
