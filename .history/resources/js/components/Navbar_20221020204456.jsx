...
const Navbar = () => {
    const {activeMenu, setactiveMenu, screenSize, setScreenSize, handleClicked, isClicked, currentColor} = useStateContext()
        ...
        <div className='flex justify-between p-2 md:mx-6 relative'>
            ...
            <div className='flex '>
                ...
                <TooltipComponent content="Profile" position='BottomCenter'>
                    ...
                    hover:bg-light-gray rounded-lg' onClick={()=>handleClicked('userProfile')}>
