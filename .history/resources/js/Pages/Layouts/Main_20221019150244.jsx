...
import remembered, { themep, setThemep, setColor, setMode } from '../../contexts/remembered'
        ...
        <div>
            <div className=" flex relative dark:bg-main-dark-bg">
                ...
                <div className={`dark:bg-main-bg bg-main-bg min-h-screen w-full ${activeMenu ? 'md:ml-72' : 'flex-2'}`}>
                    ...
                    <div>
                        <ThemeSettings themep={themep} setThemep={setThemep} setColor={setColor} setMode={setMode} />
                        {children}
                    </div>
                </div>
            </div>
